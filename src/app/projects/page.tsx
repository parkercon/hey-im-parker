  ...
  return (
    <div className='self-end overflow-scroll h-5/6 w-7/12'>
        <ul className='list-none'>
            ...
            2021-PRESENT \\ PASSION PROJECT \\ <span className='text-3xl'>BUNI SURFBOARD COMPANY</span>
            </div>
                <div className="collapse-content w-full"> 
                    <p><strong>\+ BUNI</strong></p>
                    <p>noun [U] buh • nee</p>
                    <p>A wild, provocative, arguably dumb experiment of thought and action. An eco-focused surfboard manufacturing company I co-founded in the summer of 2021. 
                    Starting from nothing more than a simple idea, we have grown to a team of 10, with two factories in Oregon, and are on track to do over $50,000 
                    in revenue this year. <br/> <br/>
                    </p>
                    <p>
            ...
            <div className="collapse bg-base-200 bg-transparent">
                <input type="checkbox"  /> 
                <div className="collapse-title text-xl font-medium">
                    2022-PRESENT \\ VOLUNTEER \\ <span className='text-3xl'>DEVELOP FOR GOOD</span>
                </div>
                <div className="collapse-content"> 
                    <p>Develop For Good is a Bay Area based non-profit originating out of Stanford University.  
                    ...
                    <p>The Environmental Defense Fund (EDF) is a global nonprofit aimed at tacking climate change. The EDF identified an issue with a lack of response to 
                        environmental and pollution hazards due to a inaccessibility in reporting these hazards. I worked as a full-stack engineer to develop a ReactJS/Flask
                        application to properly report these issues. 
                    </p>
                    <br/><br/>
            ...
            <div className="collapse bg-base-200 bg-transparent">
                <input type="checkbox"  /> 
                <div className="collapse-title text-xl font-medium">
                    2023 \\ INDUSTRY \\ <span className='text-3xl'>SAFETY CRITICAL TOOLING</span>
                </div>
                <div className="collapse-content"> 
                    <p><strong>\+ Daimler Truck North America - Software Engineering</strong></p>
                    <p>This project exists as a request from Design Engineering for a centralized way to track safety critical tools. Due to quality issues, recalls, and Corporate Audits, modules the are critical to the safety of the vehicle (ex. Brakes, Steering, Power- net) are denoted “DS” or Safety Critical. The most important of these is Torque.
                    This is because many of the safety-related recall issues stem from torque problems such as improper torque, 
                    mis-builds, or loose/missing fasteners.<br/><br/>
                    </p>
                    <p>
            ...
            <div className="collapse bg-base-200 bg-transparent">
                <input type="checkbox"  /> 
                <div className="collapse-title text-xl font-medium">
                2023 \\ INDUSTRY \\ <span className='text-3xl'>LEVEL SENSOR INTEGRATION</span>
                </div>
                <div className="collapse-content"> 
                <p><strong>\+ Daimler Truck North America - Controls & Automation Engineering</strong></p>
                <p>
            ...
            <div className="collapse bg-base-200 bg-transparent">
                <input type="checkbox"  /> 
                <div className="collapse-title text-xl font-medium">
                2023 \\ RESEARCH \\ <span className='text-3xl'>AUTONOMOUS CAR TRAJECTORY & CONTROL</span>
                </div>
                <div className="collapse-content"> 
                    <p><strong>\+ GFR - Autonomous Systems Engineering</strong></p>
                    <p>Global Formula Racing is a partnership between Oregon State University and the Duale Hochschule Baden-Wurttemberg Ravensburg. Each year the team designs and 
            ...
            <div className="collapse bg-base-200 bg-transparent">
                ...
                <div className="collapse-content"> 
                Buni Shape n&apos; Surf exists as the all-in-one suite for Surfboard Builders. Users are able to select and save surf spots around the world through the
                 Google Maps API, then either view a real-time surf forecast, lookahead into the upcoming month, or view the last year&apos;s worth of surf data—all 
                 through the Open-Meteo Marine Weather API. For the surfboard shaping side of the application, if a user finds a surfboard they would like to 
                 recreate they can visit the &quot;Shape Board&quot; page where they can either take a picture of a board or upload it from their phone. A TensorFlow Lite
                  Machine Learning Model was trained by our team for surfboard image recognition. If it really was a board that the user took a picture of, the user
                   can then enter the size of the board they would like. Our OpenCV implementation finds the outline of the board, splits it in half, and divides it 
                   into slices that fit on a standard 8.5&quot;x11&quot; piece of paper. From there, the user can save the board and print the pdf generated by ITextPdf.
                    Just like that, the user is ready to make a surfboard!
                <br/><br/>
            ...
            <div className="collapse bg-base-200 bg-transparent">
                <input type="checkbox"  /> 
                <div className="collapse-title text-xl font-medium">
                2022 \\ INDUSTRY \\ <span className='text-3xl'>TOOL READINESS NEXT</span>
                </div>
                <div className="collapse-content"> 
                    <p><strong>\+ Thermo Fisher Scientific - Software Engineering</strong></p>
                    <p>Tool Readiness exists to align and calibrate the microscope and to ensure it provides high resolution images and accurate metrology. With the constantly evolving needs of consumers, software engineering philosopies, and the current state of techonology, TR Next was needed as a replacement to the existing TR. With it comes a set of services and a comprehensive, easy to use User Interface. I was responsible for creating most of the pages on our web application, along with the logic behind it.
                        The tech stack for the appliation was .NET6, Blazor, and gRPC. <br/><br/>
                    </p>
                    <br/><br/>
